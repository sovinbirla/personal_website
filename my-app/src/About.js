...
function About(){
    ...
    const experiences = [
        {
          id: 1, name: 'Maven Wave', title: 'Software Engineer', location: 'Chicago, IL', startDate: 'Jun 2021', endDate: 'Jan 2023', points:[
        ...
        {
          id: 2, name: 'KPMG', title: 'Data Science Intern', location: 'Manhattan, NY', startDate: 'Jun 2020', endDate: 'Aug 2020', points:[
        ...
        {
          id: 3, name: 'Conagra Brands', title: 'Software Engineering Intern', location: 'Omaha, NE', startDate: 'Jun 2020', endDate: 'Aug 2020', points:[
        ...
        {
          id: 4, name: 'Fiserv', title: 'Software Engineering Intern', location: 'Omaha, NE', startDate: 'Jun 2019', endDate: 'Aug 2019', points:[
        ...
        {
          id: 5, name: 'IRisk Lab', title: 'Quantitative Research Assistant', location: 'Champaign, IL', startDate: 'Aug 2018', endDate: 'Dec 2018', points:[
